                    ...
                    <ScrollAnimation animateIn='animate__fadeInRight' animateOnce='true' duration='1'>
                        <div className='about_diagram_wrapper'>
                            <div className='about_blue_wrapper'>
                                <img src='./images/about-blue.png' className='about_diagram_img'></img>
                            ...
                            <div className='about_orange_wrapper'>
                                <img src='./images/about-orange.png' className='about_diagram_img'></img>
                            ...
                            <div className='about_green_wrapper'>
                                <img src='./images/about-green.png' className='about_diagram_img'></img>
                            ...
                            <div className='about_red_wrapper'>
                                <img src='./images/about-red.png' className='about_diagram_img'></img>
